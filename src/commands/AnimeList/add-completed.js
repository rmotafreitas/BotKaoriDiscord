...
module.exports = {
  ...
  cooldown: 2000,
  category : 'AnimeList',
  usage: "add-completed [Anime name]",
  description : 'Add a completed anime to your kaori watch list',
  /**
   * @param {Client} client
  ...
  run: async (client, message, args) => {
    ...
    data.completed.unshift(animeName);

    data.save();

    return message.inlineReply(`Added: ${animeName} to completed`);
  },
};
